...
## Who Am I?
First year Electronics and Communications Engineering student.
Passionate about robotics. Building my skills from the ground up.

## Goal
To become a skilled robotics engineer, one project at a time.

## Current Focus
- Learning Arduino basics
- Building circuits on Tinkercad
- Studying C++ and Python

## Projects
- LED Blink - In Progress
...
- Time spent: 1 hour
  ...
  ## Day 2 - 22nd March 2026
- Studied LED physics and semiconductor theory
- Learned about electron-hole recombination and photon emission
- Built first circuit on Tinkercad - LED with resistor
- Wrote first LED blink code on Tinkercad
